...
const mediaViewContent = window.matchMedia(`(max-width: 986px)`)	// 1 768px
    ...
    let viewChangeHandler = (mediaViewContent) => {  					// 3
        ...
        laptopMB.forEach((data) => {
          ...
          let listCardMB =  `<div class="card" style="width: 22rem;">
        ...
        laptopPC.forEach((data) => {
      
        
          let listCardPC =  `<div class="content-row-pcv">
                ...
                $('.container-card-pcv').append(listCardPC);
